...
<img src="addon/donate/OpenSource.png" alt="Donations" style="max-width: 95%;"/>
...
<option value="{{$c[1]}}" title="{{$c.2}}" {{if $c[1] === 'market@royalking.co.uk'}}selected="selected"{{/if}} >{{$c[0]}}</option>
{{/foreach}}
</select>
<br /><br /><br />
<input type="hidden" value="US" name="lc">
<input type="hidden" value="BlaBlaNet Donation" name="item_name">
...
<input type="hidden" name="hosted_button_id" value="XT4PW4ALJ2J7E" />
<br />
