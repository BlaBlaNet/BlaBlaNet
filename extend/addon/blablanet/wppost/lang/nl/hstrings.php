...
App::$strings["Post to WordPress by default"] = "Berichten standaard naar WordPress doorplaatsen";
App::$strings["Forward comments (requires BlaBlaNet_wp plugin)"] = "Reacties doorplaatsen (BlaBlaNet/Redmatrix WP-plugin vereist)";
