...
App::$strings["At the end of this procedure, we will give you a text to save in a file named .htconfig.php in your Red top folder."] = "Al término de este procedimiento, podemos crear un fichero de texto para guardar con el nombre .htconfig.php en el directorio raíz de su instalación de Blablanet.";
...
App::$strings["Red uses the Smarty3 template engine to render its web views. Smarty3 compiles templates to PHP to speed up rendering."] = "Blablanet hace uso del motor de plantillas Smarty3 para diseñar sus plantillas gráficas. Smarty3 es más rápido porque compila las plantillas de páginas directamente en PHP.";
...
App::$strings["Please visit <a href=\"http://Blablanet.org\">Blablanet.org</a> to learn more about \$Projectname."] = "Por favor, visite <a href=\"http://Blablanet.org\">Blablanet.org</a> para más información sobre \$Projectname.";
...
App::$strings["Focus (Blablanet default)"] = "Focus (predefinido)";
App::$strings["Theme settings"] = "Ajustes del tema";
...
App::$strings["Create an account to access services and applications within the Blablanet"] = "Crear una cuenta para acceder a los servicios y aplicaciones dentro de Blablanet";
...
App::$strings["[Blablanet] Website SSL error for %s"] = "[Blablanet] Error SSL del sitio web en %s";
App::$strings["Cron/Scheduled tasks not running."] = "Las tareas del Planificador/Cron no están funcionando.";
App::$strings["[Blablanet] Cron tasks not running on %s"] = "[Blablanet] Las tareas de Cron no están funcionando en %s";
