...
App::$strings["Minimum project version: "] = "Minima versione Blablanet";
App::$strings["Maximum project version: "] = "Massima versione Blablanet";
...
App::$strings["Import Public Streams"] = "Suggerisci contenuti pubblici della rete Blablanet";
App::$strings["Import and allow access to public content pulled from other sites. Warning: this content is unmoderated."] = "Suggerisci e visualizza i post pubblici presenti su altri siti Blablanet. Attenzione: i contenuti potrebbero essere inappropriati perché non sottoposti a moderazione.";
...
App::$strings["Your account email address must match this in order to use the web admin panel."] = "Il tuo indirizzo email deve corrispondere a questo per poter usare il pannello di amministrazione di Blablanet.";
...
App::$strings["The web installer needs to be able to create a file called \".htconfig.php\" in the top folder of your web server and it is unable to do so."] = "L'installazione web deve poter creare un file chiamato \".htconfig.php\" nella cartella di Blablanet ma non è in grado di farlo.";
...
App::$strings["At the end of this procedure, we will give you a text to save in a file named .htconfig.php in your Red top folder."] = "Alla fine di questa procedura ti sarà dato il testo da salvare in un file di nome .htconfig.php dentro la cartella principale di Blablanet.";
...
App::$strings["Red uses the Smarty3 template engine to render its web views. Smarty3 compiles templates to PHP to speed up rendering."] = "Blablanet usa il sistema Smarty3 per costruire i suoi template grafici. Smarty3 è molto veloce perché compila i template delle pagine direttamente in PHP.";
...
App::$strings["Please visit <a href=\"http://Blablanet.org\">Blablanet.org</a> to learn more about \$Projectname."] = "Visita <a href=\"http://Blablanet.org\">Blablanet.org</a> per maggiori informazioni su \$Projectname.";
...
App::$strings["<a href=\"pubsites\">Register at another affiliated hub.</a>"] = "<a href=\"pubsites\">Registrati su un altro server Blablanet.</a>";
...
App::$strings["Focus (Blablanet default)"] = "Focus (predefinito)";
App::$strings["Theme settings"] = "Impostazioni del tema";
...
App::$strings["Create an account to access services and applications within the Blablanet"] = "Registrati per accedere ai servizi e alle applicazioni di Blablanet";
...
App::$strings["[Blablanet] Website SSL error for %s"] = "[Blablanet] Errore SSL su %s";
App::$strings["Cron/Scheduled tasks not running."] = "Processi cron non avviati.";
App::$strings["[Blablanet] Cron tasks not running on %s"] = "[Blablanet] Cron non è stato eseguito %s";
