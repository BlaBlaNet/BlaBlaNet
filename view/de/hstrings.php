...
App::$strings["Must be writable by web server. Relative to your top-level webserver directory."] = "Muss für den Web-Server schreibbar sein. Relativ zum Blablanet-Stammverzeichnis.";
...
App::$strings["At the end of this procedure, we will give you a text to save in a file named .htconfig.php in your Red top folder."] = "Am Schluss dieses Vorgangs wird ein Text generiert, den Du unter dem Dateinamen .htconfig.php im Stammverzeichnis Deiner Blablanet-Installation speichern musst.";
...
App::$strings["In order to store these compiled templates, the web server needs to have write access to the directory %s under the top level web folder."] = "Um diese kompilierten Vorlagen speichern zu können, braucht der Web-Server Schreibzugriff auf das Verzeichnis %s unterhalb des Blablanet-Stammverzeichnisses.";
...
App::$strings["Please visit <a href=\"http://Blablanet.org\">Blablanet.org</a> to learn more about \$Projectname."] = "Bitte besuchen Sie <a href=\"http://Blablanet.org\">Blablanet.org</a>, um mehr über \$Projectname zu erfahren.";
...
App::$strings["[Blablanet:Notify] New mail received at %s"] = "[Blablanet:Benachrichtigung] Neue Mail empfangen auf %s";
...
App::$strings["[Blablanet:Notify] Comment to conversation #%1\$d by %2\$s"] = "[Blablanet:Benachrichtigung] Kommentar in Unterhaltung #%1\$d von %2\$s";
...
App::$strings["[Blablanet:Notify] %s posted to your profile wall"] = "[Blablanet:Benachrichtigung] %s schrieb auf Deine Pinnwand";
...
App::$strings["[Blablanet:Notify] %s tagged you"] = "[Blablanet:Benachrichtigung] %s hat Dich erwähnt";
...
App::$strings["[Blablanet:Notify] %1\$s poked you"] = "[Blablanet:Benachrichtigung] %1\$s hat Dich angestupst";
...
App::$strings["[Blablanet:Notify] %s tagged your post"] = "[Blablanet:Benachrichtigung] %s  hat Deinen Beitrag verschlagwortet";
...
App::$strings["[Blablanet:Notify] Introduction received"] = "[Blablanet:Benachrichtigung] Vorstellung erhalten";
...
App::$strings["[Blablanet:Notify] Friend suggestion received"] = "[Blablanet:Benachrichtigung] Freundschaftsvorschlag erhalten";
...
App::$strings["[Blablanet:Notify]"] = "[Blablanet:Benachrichtigung]";
...
App::$strings["Focus (Blablanet default)"] = "Focus (Voreinstellung für Blablanet)";
App::$strings["Theme settings"] = "Theme-Einstellungen";
...
App::$strings["Create an account to access services and applications within the Blablanet"] = "Erstelle ein Konto, um Anwendungen und Dienste innerhalb von Blablanet nutzen zu können.";
...
App::$strings["[Blablanet] Website SSL error for %s"] = "[Blablanet] Website-SSL-Fehler für %s";
App::$strings["Cron/Scheduled tasks not running."] = "Cron-Aufgaben laufen nicht.";
App::$strings["[Blablanet] Cron tasks not running on %s"] = "[Blablanet] Cron-Aufgaben für %s laufen nicht";
