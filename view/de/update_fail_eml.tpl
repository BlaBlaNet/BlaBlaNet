...
Die BlaBlaNet-Entwickler haben kürzlich das Update {{$update}} veröffentlicht, 
...
Bitte kontaktiere einen BlaBlaNet-Entwickler, wenn Du nicht weißt, wie Du das Problem 
...
Bitte entschuldige die Unannehmlichkeit, 
	Dein BlaBlaNet-Server auf {{$siteurl}}
