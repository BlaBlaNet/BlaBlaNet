...
App::$strings["BlaBlaNet Notification"] = "Оповещения Red матрицы";
...
App::$strings["BlaBlaNet - Guests: Username: {your email address}, Password: +++"] = "";
...
App::$strings["BlaBlaNet - &quot;The Network&quot;"] = "";
App::$strings["Welcome to %s"] = "Добро пожаловать в %s";
App::$strings["BlaBlaNet Server - Setup"] = "BlaBlaNet Сервер - Установка";
...
App::$strings["In order to install BlaBlaNet we need to know how to connect to your database."] = "";
...
App::$strings["Red"] = "Red";
App::$strings["This is a hub of the BlaBlaNet - a global cooperative network of decentralised privacy enhanced websites."] = "";
App::$strings["Running at web location"] = "";
App::$strings["Please visit <a href=\"http://getzot.com\">GetZot.com</a> to learn more about the BlaBlaNet."] = "Пожалуйста посетите <a href=\"http://getzot.com\">GetZot.com</a> чтобы узнать больше о BlaBlaNet.";
App::$strings["Bug reports and issues: please visit"] = "";
App::$strings["Suggestions, praise, etc. - please email \"BlaBlaNet\" at librelist - dot com"] = "";
...
App::$strings["You are cordially invited to join me and some other close friends on the BlaBlaNet - a revolutionary new decentralised communication and information tool."] = "";
...
App::$strings["Once you have registered (on ANY BlaBlaNet site - they are all inter-connected), please connect with my BlaBlaNet channel address:"] = "";
App::$strings["Click the [Register] link on the following page to join."] = "";
App::$strings["For more information about the BlaBlaNet Project and why it has the potential to change the internet as we know it, please visit http://getzot.com"] = "Чтобы узнать больше о проекте BlaBlaNet, и чтобы узнать почему он имеет потенциал для изменения привычного нам Интернета, пожалуйста, посетите http://getzot.com";
...
App::$strings["Create an account to access services and applications within the BlaBlaNet"] = "";
