...
then
    ...
    sed -i "s/PACKAGE/BlaBlaNet $ADDONNAME addon/g" "$OUTFILE"
    sed -i "s/CHARSET/UTF-8/g" "$OUTFILE"
	sed -i '/^\"Plural-Forms/d' "$OUTFILE"
else
    sed -i "s/SOME DESCRIPTIVE TITLE./BlaBlaNet Project/g" "$OUTFILE"
    sed -i "s/YEAR THE PACKAGE'S COPYRIGHT HOLDER/2012-2014 the BlaBlaNet Project/g" "$OUTFILE"
