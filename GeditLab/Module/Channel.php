...
class Channel extends \GeditLab\Web\Controller {
	...
	function get($update = 0, $load = false) {
		...
		$checkjs = new \GeditLab\Web\CheckJS(1);
		...
		if(! $update) {
			...
			if($perms['post_wall']) {
				...
				$x = array(
					...
					'acl' => (($is_owner) ? populate_acl($channel_acl,true, \GeditLab\Lib\PermissionDescription::fromGlobalPermission('view_stream'), get_post_aclDialogDescription(), 'acl_dialog_post') : ''),
