...
class Well_known extends \GeditLab\Web\Controller {
		...
		if(argc() > 1) {
			...
			switch(argv(1)) {
				case 'zot-info':
					...
					\App::$argv[0] = 'zfinger';
					$module = new \GeditLab\Module\Zfinger();
					$module->init();
					break;
				...
				case 'webfinger':
					...
					array_shift(\App::$argv);
					\App::$argv[0] = 'wfinger';
					$module = new \GeditLab\Module\Wfinger();
					$module->init();
					break;
				...
				case 'host-meta':
					...
					array_shift(\App::$argv);
					\App::$argv[0] = 'hostxrd';
					$module = new \GeditLab\Module\Hostxrd();
					$module->init();
					break;
