...
class Rpost extends \GeditLab\Web\Controller {
	...
	//		$plaintext = false;
		...
		$x = array(
			...
			'acl' => populate_acl($channel_acl, true, \GeditLab\Lib\PermissionDescription::fromGlobalPermission('view_stream'), get_post_aclDialogDescription(), 'acl_dialog_post'),
