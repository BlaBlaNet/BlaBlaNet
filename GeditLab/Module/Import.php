...
class Import extends \GeditLab\Web\Controller {
	...
	//	print_r($data);
		...
		\GeditLab\Daemon\Master::Summon(array('Notifier','location',$channel['channel_id']));
	
		// This will indirectly perform a refresh_all *and* update the directory
	
		\GeditLab\Daemon\Master::Summon(array('Directory', $channel['channel_id']));
