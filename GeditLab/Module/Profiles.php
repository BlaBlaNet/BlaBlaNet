...
class Profiles extends \GeditLab\Web\Controller {
	...
	//logger('extra_fields: ' . print_r($extra_fields,true));
			...
			$o .= replace_macros($tpl,array(
				...
				'$default'      => t('This is your default profile.') . EOL . translate_scope(map_scope(\GeditLab\Access\PermissionLimits::Get($channel['channel_id'],'view_profile'))),
				'$advanced'     => $advanced,
				...
				foreach($r as $rr) {
					$profiles .= replace_macros($tpl, array(
						...
						'$visible' => (($rr['is_default']) 
							? '<strong>' . translate_scope(map_scope(\GeditLab\Access\PermissionLimits::Get($channel['channel_id'],'view_profile'))) . '</strong>' 
