...
class Like extends \GeditLab\Web\Controller {
	...
	function get() {
		...
		if(argc() == 3) {
			...
			if($r) {
				...
				foreach($r as $rr) {
					...
					\GeditLab\Daemon\Master::Summon(array('Notifier','drop',$rr['id']));
		...
		\GeditLab\Daemon\Master::Summon(array('Notifier','like',$post_id));
