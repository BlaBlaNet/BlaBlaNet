...
class Filestorage extends \GeditLab\Web\Controller {
	...
	function get() {
		...
		if(argc() > 3 && argv(3) === 'edit') {
			...
			$aclselect_e = populate_acl($f, false, \GeditLab\Lib\PermissionDescription::fromGlobalPermission('view_storage'));
