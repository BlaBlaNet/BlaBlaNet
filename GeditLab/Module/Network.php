...
class Network extends \GeditLab\Web\Controller {
	...
	function get($update = 0, $load = false) {
		...
		if(! $update) {
			...
			$x = array(
				...
				'acl'              => populate_acl((($private_editing) ? $def_acl : $channel_acl), true, \GeditLab\Lib\PermissionDescription::fromGlobalPermission('view_stream'), get_post_aclDialogDescription(), 'acl_dialog_post'),
