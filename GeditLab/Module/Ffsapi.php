...
class Ffsapi extends \GeditLab\Web\Controller {
	...
	var data = {
	  ...
	  // currently required
	  "name": '$name',
	  "iconURL": baseurl+"/images/bb-16.png",
	  "icon32URL": baseurl+"/images/bb-32.png",
	  "icon64URL": baseurl+"/images/bb-64.png",
	  ...
	  "unmarkedIcon": baseurl+"/images/bb-bookmark-32.png",
